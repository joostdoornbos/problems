Consider the infinite unit square grid graph. Draw a line segment between the points $$(0,0)\ \text{and}\ (m,n).$$ How many square faces does this segment pass through?  
